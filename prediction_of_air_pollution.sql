...
--
-- Host: localhost
-- Generation Time: Jul 25, 2022 at 09:51 AM
...
--
-- Database: `prediction_of_air_pollution`
--
CREATE DATABASE IF NOT EXISTS `prediction_of_air_pollution` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `prediction_of_air_pollution`;
...
--
-- Table structure for table `remote_user_air_quality_type`
--

CREATE TABLE IF NOT EXISTS `remote_user_air_quality_type` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `City` varchar(300) NOT NULL,
  `Date` varchar(300) NOT NULL,
  `PM2andhalf` varchar(300) NOT NULL,
  `PM10` varchar(300) NOT NULL,
  `NO` varchar(300) NOT NULL,
  `NO2` varchar(300) NOT NULL,
  `Nox` varchar(300) NOT NULL,
  `NH3` varchar(300) NOT NULL,
  `CO` varchar(300) NOT NULL,
  `SO2` varchar(300) NOT NULL,
  `O3` varchar(300) NOT NULL,
  `Benzene` varchar(300) NOT NULL,
  `Toluene` varchar(300) NOT NULL,
  `Xylene` varchar(300) NOT NULL,
  `AQI` varchar(300) NOT NULL,
...
--
-- Dumping data for table `remote_user_air_quality_type`
--

INSERT INTO `remote_user_air_quality_type` (`id`, `City`, `Date`, `PM2andhalf`, `PM10`, `NO`, `NO2`, `Nox`, `NH3`, `CO`, `SO2`, `O3`, `Benzene`, `Toluene`, `Xylene`, `AQI`, `aid`, `Prediction`) VALUES
(1, 'Ahmedabad', '02-01-2021', '0', '28.41', '0.97', '15.69', '16.46', '0', '0.97', '24.55', '34.06', '3.68', '5.5', '3.77', '676', '[''ddc40ffc47069f3714c8da65843f36f41ed0f8bb'']', 'Severe'),
(2, 'Ahmedabad', '11-01-2021', 'NA', '128.41', '132.07', '55.8', '24.53', 'NA', '132.07', '25.03', '6.79', '0', '0', '0', '340', '[''430088e2d738c4c20413082888b2666668c9105f'']', 'Poor'),
(3, 'Ahmedabad', '13-01-21', 'NA', '68.41', '48.82', '44.2', '87.09', 'NA', '48.82', '68.21', '35.16', '9.45', '13.35', '12.5', '560', '[''e1200121af466e437f3cf17aa10654b7725edb07'']', 'Moderate'),
(4, 'Ahmedabad', '18-12-2018', '238.42', '32.48', '26.3', '73.22', '32.07', 'NA', '26.3', '34.63', '63.89', '4.08', '32.34', '6.94', '381', '[''345180770287ab9188e2dcfa2fd2ba0cd58214bb'']', 'Very Poor');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_air_quality_type_ratio`
--

CREATE TABLE IF NOT EXISTS `remote_user_air_quality_type_ratio` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `remote_user_air_quality_type_ratio`
--

INSERT INTO `remote_user_air_quality_type_ratio` (`id`, `names`, `ratio`) VALUES
(18, 'Poor', '25.0'),
(19, 'Very Poor', '25.0'),
(20, 'Severe', '25.0'),
(21, 'Moderate', '25.0');
...
(91, 'SVM', '33.62573099415205'),
(92, 'Logistic Regression', '33.57699805068226'),
(93, 'Decision Tree Classifier', '33.62573099415205'),
(94, 'KNeighborsClassifier', '32.69980506822613');
